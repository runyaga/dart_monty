...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    _fetchText(url) {
      ...
      var $async$_fetchText = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp2 = A;
              $async$goto = 4;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(init.G.fetch(url)), type$.JSObject), $async$_fetchText);
            case 4:
              // returning from await.
              $async$goto = 3;
              return A._asyncAwait($async$temp1.promiseToFuture($async$temp2._asJSObject($async$result.text()), type$.String), $async$_fetchText);
            case 3:
              // returning from await.
      ...
      return A._asyncStartSync($async$_fetchText, $async$completer);
    },
    main() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, $async$handler = 2, $async$errorStack = [], bridge, tierFile, json, fixtures, fixture, nativeOnly, result, e, t1, t2, retries, retries0, t3, t4, _i, t5, t6, t7, exception, $async$exception;
      var $async$main = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              A.print("=== Web Python Ladder Runner ===");
              t1 = init.G, t2 = type$.dynamic, retries = 0;
            case 3:
              // for condition
              if (!!("DartMontyBridge" in t1)) {
                // goto after for
                $async$goto = 5;
                break;
              }
              retries0 = retries + 1;
              if (retries > 50) {
                A.printString("LADDER_ERROR:DartMontyBridge class never loaded on window");
                A.printString("LADDER_DONE");
                // goto return
                $async$goto = 1;
                break;
              }
              $async$goto = 6;
              return A._asyncAwait(A.Future_Future$delayed(B.Duration_50000, t2), $async$main);
            case 6:
              // returning from await.
            case 4:
              // for update
            ...
            case 5:
              // after for
              bridge = A._asJSObject(new t1.DartMontyBridge());
              $async$goto = 7;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(bridge.init()), type$.bool), $async$main);
            case 7:
              // returning from await.
              if (!$async$result) {
                A.print("LADDER_ERROR:Monty Worker init failed");
                A.print("LADDER_DONE");
                // goto return
                $async$goto = 1;
                break;
              }
              t1 = type$.String, t3 = type$.List_dynamic, t4 = type$.Map_String_dynamic, _i = 0;
            case 8:
              // for condition
              if (!(_i < 18)) {
                // goto after for
              ...
              tierFile = B.List_Ziq[_i];
              $async$handler = 12;
              $async$goto = 15;
              return A._asyncAwait(A._fetchText(tierFile), $async$main);
            case 15:
              // returning from await.
              json = $async$result;
              fixtures = J.cast$1$0$ax(t3._as(B.C_JsonCodec.decode$2$reviver(json, null)), t4);
              t5 = fixtures, t6 = A.instanceType(t5), t5 = new A.ListIterator(t5, J.get$length$asx(t5), t6._eval$1("ListIterator<ListBase.E>")), t6 = t6._eval$1("ListBase.E");
            case 16:
              // for condition
              if (!t5.moveNext$0()) {
                // goto after for
              ...
              t7 = t5._current;
              fixture = t7 == null ? t6._as(t7) : t7;
              t7 = A._asBoolQ(J.$index$ax(fixture, "nativeOnly"));
              nativeOnly = t7 === true;
              if (nativeOnly) {
                A.printString("LADDER_RESULT:" + B.C_JsonCodec.encode$2$toEncodable(A.LinkedHashMap_LinkedHashMap$_literal(["id", J.$index$ax(fixture, "id"), "ok", true, "skipped", true, "reason", "nativeOnly"], t1, t2), null));
                // goto for condition
                $async$goto = 16;
                break;
              }
              $async$goto = 18;
              return A._asyncAwait(A._runFixture(bridge, fixture), $async$main);
            case 18:
              // returning from await.
              result = $async$result;
              A.printString("LADDER_RESULT:" + B.C_JsonCodec.encode$2$toEncodable(result, null));
              // goto for condition
              $async$goto = 16;
              break;
            case 17:
            ...
            case 12:
              ...
              t5 = A.S(tierFile);
              t6 = A.S(e);
              A.printString("LADDER_ERROR:Failed to load " + t5 + ": " + t6);
              // goto after finally
              $async$goto = 14;
              break;
            case 11:
            ...
            case 10:
              // after for
              $async$goto = 19;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(bridge.dispose()), type$.nullable_Object), $async$main);
            case 19:
              // returning from await.
              A.print("LADDER_DONE");
            case 1:
    ...
    _runFixture(bridge, fixture) {
      return A._runFixture$body(bridge, fixture);
    },
    _runFixture$body(bridge, fixture) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.Map_String_dynamic),
        $async$returnValue, $async$handler = 2, $async$errorStack = [], e, exception, t2, id, code, t1, expectError, xfail, result, $async$exception;
      var $async$_runFixture = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
          $async$errorStack.push($async$result);
          $async$goto = $async$handler;
        }
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              id = A._asInt(fixture.$index(0, "id"));
              code = A._asString(fixture.$index(0, "code"));
              t1 = A._asBoolQ(fixture.$index(0, "expectError"));
              expectError = t1 === true;
              xfail = A._asStringQ(fixture.$index(0, "xfail"));
              result = null;
              $async$handler = 4;
              $async$goto = fixture.$index(0, "externalFunctions") != null ? 7 : 9;
              break;
            case 7:
              // then
              $async$goto = 10;
              return A._asyncAwait(A._runIterative(bridge, fixture), $async$_runFixture);
            case 10:
              // returning from await.
              result = $async$result;
              // goto join
            ...
            case 9:
              // else
              $async$goto = expectError ? 11 : 13;
              break;
            case 11:
              // then
              $async$goto = 14;
              return A._asyncAwait(A._runExpectError(bridge, id, code), $async$_runFixture);
            case 14:
              // returning from await.
              result = $async$result;
              // goto join
            ...
            case 13:
              // else
              $async$goto = 15;
              return A._asyncAwait(A._runSimple(bridge, id, code), $async$_runFixture);
            case 15:
              // returning from await.
              result = $async$result;
            case 12:
            ...
            case 4:
              ...
              $async$exception = $async$errorStack.pop();
              e = A.unwrapException($async$exception);
              result = A.LinkedHashMap_LinkedHashMap$_literal(["id", id, "ok", false, "error", A.S(e)], type$.String, type$.dynamic);
              // goto after finally
              $async$goto = 6;
              break;
            case 3:
            ...
            case 6:
              ...
              if (xfail != null) {
                t1 = type$.String;
                t2 = type$.dynamic;
                if (J.$eq$(J.$index$ax(result, "ok"), true)) {
                  $async$returnValue = A.LinkedHashMap_LinkedHashMap$_literal(["id", id, "ok", true, "xpass", true], t1, t2);
                  // goto return
                  $async$goto = 1;
                  break;
                } else {
                  $async$returnValue = A.LinkedHashMap_LinkedHashMap$_literal(["id", id, "ok", true, "xfail", true], t1, t2);
                  // goto return
                  $async$goto = 1;
                  break;
                }
      ...
      return A._asyncStartSync($async$_runFixture, $async$completer);
    },
    _runSimple(bridge, id, code) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.Map_String_dynamic),
        $async$returnValue, t1, result, $async$temp1, $async$temp2;
      var $async$_runSimple = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              $async$goto = 3;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(bridge.run(code)), t1), $async$_runSimple);
            case 3:
              // returning from await.
              result = $async$temp1._as($async$temp2.decode$2$reviver($async$result, null));
              if (J.$eq$(result.$index(0, "ok"), true)) {
                $async$returnValue = A.LinkedHashMap_LinkedHashMap$_literal(["id", id, "ok", true, "value", result.$index(0, "value")], t1, type$.dynamic);
                // goto return
                $async$goto = 1;
                break;
              }
              $async$returnValue = A.LinkedHashMap_LinkedHashMap$_literal(["id", id, "ok", false, "error", result.$index(0, "error")], t1, type$.dynamic);
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$_runSimple, $async$completer);
    },
    _runExpectError(bridge, id, code) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.Map_String_dynamic),
        $async$returnValue, t1, result, $async$temp1, $async$temp2;
      var $async$_runExpectError = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp2 = B.C_JsonCodec;
              $async$goto = 3;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(bridge.run(code)), t1), $async$_runExpectError);
            case 3:
              // returning from await.
              result = $async$temp1._as($async$temp2.decode$2$reviver($async$result, null));
              if (J.$eq$(result.$index(0, "ok"), false)) {
                $async$returnValue = A.LinkedHashMap_LinkedHashMap$_literal(["id", id, "ok", true, "error", result.$index(0, "error")], t1, type$.dynamic);
                // goto return
                $async$goto = 1;
                break;
              }
              $async$returnValue = A.LinkedHashMap_LinkedHashMap$_literal(["id", id, "ok", false, "error", "Expected error but succeeded"], t1, type$.dynamic);
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$_runExpectError, $async$completer);
    },
    _runIterative(bridge, fixture) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.Map_String_dynamic),
        $async$returnValue, resumeErrors, resultJson, t4, t5, id, code, t1, extFns, t2, t3, resumeValues, $async$temp1, $async$temp2;
      var $async$_runIterative = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              code = A._asString(fixture.$index(0, "code"));
              t1 = type$.String;
              extFns = J.cast$1$0$ax(type$.List_dynamic._as(fixture.$index(0, "externalFunctions")), t1);
              t2 = type$.nullable_List_dynamic;
              t3 = t2._as(fixture.$index(0, "resumeValues"));
              resumeValues = t3 == null ? null : J.cast$1$0$ax(t3, type$.Object);
              t2 = t2._as(fixture.$index(0, "resumeErrors"));
              resumeErrors = t2 == null ? null : J.cast$1$0$ax(t2, t1);
              t2 = type$.Map_String_dynamic;
              $async$temp1 = t2;
              $async$temp2 = B.C_JsonCodec;
              $async$goto = 3;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(bridge.start(code, B.C_JsonCodec.encode$2$toEncodable(extFns, null))), t1), $async$_runIterative);
            case 3:
              // returning from await.
              resultJson = $async$temp1._as($async$temp2.decode$2$reviver($async$result, null));
              if (!J.$eq$(resultJson.$index(0, "ok"), true)) {
                $async$returnValue = A.LinkedHashMap_LinkedHashMap$_literal(["id", id, "ok", false, "error", resultJson.$index(0, "error")], t1, type$.dynamic);
                // goto return
                $async$goto = 1;
                break;
              }
              $async$goto = resumeErrors != null ? 4 : 6;
              break;
            case 4:
              // then
              t3 = resumeErrors.$ti, t4 = new A.ListIterator(resumeErrors, resumeErrors.get$length(0), t3._eval$1("ListIterator<ListBase.E>")), t3 = t3._eval$1("ListBase.E");
            case 7:
              // for condition
              if (!t4.moveNext$0()) {
                // goto after for
              ...
              if (t5 == null)
                t5 = t3._as(t5);
              if (!J.$eq$(resultJson.$index(0, "state"), "pending")) {
                $async$returnValue = A.LinkedHashMap_LinkedHashMap$_literal(["id", id, "ok", false, "error", "Expected pending state"], t1, type$.dynamic);
                // goto return
                $async$goto = 1;
                break;
              }
              ...
              $async$temp2 = B.C_JsonCodec;
              $async$goto = 9;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(bridge.resumeWithError(B.C_JsonCodec.encode$2$toEncodable(t5, null))), t1), $async$_runIterative);
            case 9:
              // returning from await.
              resultJson = $async$temp1._as($async$temp2.decode$2$reviver($async$result, null));
              // goto for condition
            ...
            case 6:
              // else
              $async$goto = resumeValues != null ? 10 : 11;
              break;
            case 10:
              // then
              t3 = resumeValues.$ti, t4 = new A.ListIterator(resumeValues, resumeValues.get$length(0), t3._eval$1("ListIterator<ListBase.E>")), t3 = t3._eval$1("ListBase.E");
            case 12:
              // for condition
              if (!t4.moveNext$0()) {
                // goto after for
              ...
              $async$temp2 = B.C_JsonCodec;
              $async$goto = 14;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(bridge.resume(B.C_JsonCodec.encode$2$toEncodable(t5, null))), t1), $async$_runIterative);
            case 14:
              // returning from await.
              resultJson = $async$temp1._as($async$temp2.decode$2$reviver($async$result, null));
              // goto for condition
            ...
            case 5:
              ...
              $async$returnValue = A.LinkedHashMap_LinkedHashMap$_literal(["id", id, "ok", true, "value", resultJson.$index(0, "value")], t1, type$.dynamic);
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$_runIterative, $async$completer);
    }
  },
  B = {};
  var holders = [A, J, B];
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._awaitOnObject_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.promiseToFuture_closure, A.promiseToFuture_closure0]);
...
;
    ...
    B.List_Ziq = makeConstList(["fixtures/tier_01_expressions.json", "fixtures/tier_02_variables.json", "fixtures/tier_03_control_flow.json", "fixtures/tier_04_functions.json", "fixtures/tier_05_errors.json", "fixtures/tier_06_external_fns.json", "fixtures/tier_07_advanced.json", "fixtures/tier_08_kwargs.json", "fixtures/tier_09_exceptions.json", "fixtures/tier_10_math_module.json", "fixtures/tier_11_re_module.json", "fixtures/tier_12_monty_008_features.json", "fixtures/tier_13_async.json", "fixtures/tier_15_script_name.json", "fixtures/tier_16_memory_growth.json", "fixtures/tier_17_json_module.json", "fixtures/tier_18_datetime_module.json", "fixtures/tier_19_lifecycle_errors.json"], type$.JSArray_String);
...
//# sourceMappingURL=ladder_runner.dart.js.map
