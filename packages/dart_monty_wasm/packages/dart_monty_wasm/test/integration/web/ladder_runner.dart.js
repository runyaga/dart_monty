  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var $async$goto = 0,
        ...
        $async$returnValue, $async$handler = 2, $async$errorStack = [], tierFile, json, fixtures, fixture, nativeOnly, result, e, t1, t2, t3, t4, _i, t5, t6, t7, exception, $async$exception;
      var $async$main = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              A.print("=== WASM Python Ladder Runner ===");
              $async$goto = 3;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(init.G.DartMontyBridge.init()), type$.bool), $async$main);
            case 3:
              // returning from await.
              if (!$async$result) {
              ...
              t1 = type$.String, t2 = type$.dynamic, t3 = type$.List_dynamic, t4 = type$.Map_String_dynamic, _i = 0;
            case 4:
              // for condition
              if (!(_i < 6)) {
                // goto after for
            ...
            case 12:
              ...
              $async$goto = 14;
              return A._asyncAwait(A._runFixture(fixture), $async$main);
            case 14:
              // returning from await.
              result = $async$result;
    ...
    _runFixture(fixture) {
      return A._runFixture$body(fixture);
    },
    _runFixture$body(fixture) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.Map_String_dynamic),
        $async$returnValue, $async$handler = 2, $async$errorStack = [], e, exception, id, code, t1, expectError, $async$exception;
        ...
        for (;;)
          switch ($async$goto) {
            ...
            case 7:
              // then
              $async$goto = 10;
              return A._asyncAwait(A._runIterative(fixture), $async$_runFixture);
            case 10:
              // returning from await.
              t1 = $async$result;
            ...
            case 11:
              // then
              $async$goto = 14;
              return A._asyncAwait(A._runExpectError(id, code), $async$_runFixture);
            case 14:
              // returning from await.
              t1 = $async$result;
              $async$returnValue = t1;
            ...
            case 13:
              // else
              $async$goto = 15;
              return A._asyncAwait(A._runSimple(id, code), $async$_runFixture);
            case 15:
              // returning from await.
              t1 = $async$result;
              $async$returnValue = t1;
            ...
            case 4:
              ...
              $async$exception = $async$errorStack.pop();
              e = A.unwrapException($async$exception);
              t1 = A.LinkedHashMap_LinkedHashMap$_literal(["id", id, "ok", false, "error", A.S(e)], type$.String, type$.dynamic);
              $async$returnValue = t1;
              // goto return
              $async$goto = 1;
              break;
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              $async$goto = 3;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(init.G.DartMontyBridge.run(code)), t1), $async$_runSimple);
            case 3:
              // returning from await.
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp2 = B.C_JsonCodec;
              $async$goto = 3;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(init.G.DartMontyBridge.run(code)), t1), $async$_runExpectError);
            case 3:
              // returning from await.
              result = $async$temp1._as($async$temp2.decode$2$reviver($async$result, null));
    ...
    _runIterative(fixture) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.Map_String_dynamic),
        $async$returnValue, resumeErrors, resultJson, t4, t5, t6, id, code, t1, extFns, t2, t3, resumeValues, $async$temp1, $async$temp2;
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp2 = B.C_JsonCodec;
              $async$goto = 3;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(t2.DartMontyBridge.start(code, B.C_JsonCodec.encode$2$toEncodable(extFns, null))), t1), $async$_runIterative);
            case 3:
              // returning from await.
            ...
            case 4:
              // then
              t4 = resumeErrors.$ti, t5 = new A.ListIterator(resumeErrors, resumeErrors.get$length(0), t4._eval$1("ListIterator<ListBase.E>")), t4 = t4._eval$1("ListBase.E");
            case 7:
              // for condition
              if (!t5.moveNext$0()) {
                // goto after for
              ...
              $async$temp2 = B.C_JsonCodec;
              $async$goto = 9;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(t2.DartMontyBridge.resumeWithError(B.C_JsonCodec.encode$2$toEncodable(t6, null))), t1), $async$_runIterative);
            case 9:
              // returning from await.
              resultJson = $async$temp1._as($async$temp2.decode$2$reviver($async$result, null));
              // goto for condition
            ...
            case 10:
              // then
              t4 = resumeValues.$ti, t5 = new A.ListIterator(resumeValues, resumeValues.get$length(0), t4._eval$1("ListIterator<ListBase.E>")), t4 = t4._eval$1("ListBase.E");
            case 12:
              // for condition
              if (!t5.moveNext$0()) {
                // goto after for
              ...
              $async$temp2 = B.C_JsonCodec;
              $async$goto = 14;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(t2.DartMontyBridge.resume(B.C_JsonCodec.encode$2$toEncodable(t6, null))), t1), $async$_runIterative);
            case 14:
              // returning from await.
              resultJson = $async$temp1._as($async$temp2.decode$2$reviver($async$result, null));
              // goto for condition
...
;
    ...
    B.List_871 = makeConstList(["fixtures/tier_01_expressions.json", "fixtures/tier_02_variables.json", "fixtures/tier_03_control_flow.json", "fixtures/tier_04_functions.json", "fixtures/tier_05_errors.json", "fixtures/tier_06_external_fns.json"], type$.JSArray_String);
