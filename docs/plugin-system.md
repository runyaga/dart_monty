...
| Advanced | [Host Functions Advanced](guides/host-functions-advanced.md) | Composite plugins, `PluginRef`, `IsolatePlugin`, child spawning, depth/concurrency limits, production patterns |
